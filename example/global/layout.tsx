...
const DynamicBannerMessage = dynamic(
  () => import("../components/interface/bannerMessage"),
  {
    ssr: false,
  }
);

const DynamicNotificationTray = dynamic(
  () => import("../components/interface/notificationTray"),
  {
    ssr: false,
    loading: () => (
      <StyledNotificationTray>
