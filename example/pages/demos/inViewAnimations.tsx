        ...
        <StyledPage>
            <ObserverContextProvider rootMargin="-200px 0px -5% 0px" threshold={[0, 0.1, 0.25, 0.5, 0.75, 0.9, 1]}>
                ...
                <InViewComponent transitionStyle='fade-in'>
                    <StyledPanel>
                        <Header3><StyledCodeHeader>fade-in</StyledCodeHeader></Header3>
                ...
                <InViewComponent transitionStyle='fade-side' threshold={0.95}>
                    <StyledPanel>
                        <Header3><StyledCodeHeader>fade-side</StyledCodeHeader></Header3>
                ...
                <InViewComponent transitionStyle='fade-up' threshold={0}>
                    <StyledPanel>
                        <Header3><StyledCodeHeader>fade-up</StyledCodeHeader></Header3>
                ...
                <InViewComponent transitionStyle='fade-side' threshold={0} untrackOnCallback={true}>
                    <StyledPanel>
                        <Header3><StyledCodeHeader>Single Transition</StyledCodeHeader></Header3>
                ...
                <InViewComponent transitionStyle='none' callback={inViewCallback}>
                    <StyledPanel>
                        <Header3><StyledCodeHeader>none</StyledCodeHeader></Header3>
                        ...
                        />
                        <ParagraphComponent text={`The current threshold of this component is ${currentThreshold}`}
                        />
